import{S as d}from"./swiper-bundle-ODHXgc7Q.js";let f=()=>{let e=t=>document.querySelector(t),a=t=>document.querySelectorAll(t),c=()=>{a(".other-cards").forEach(t=>{t.classList.contains("translate-x-[600px]")&&t.classList.contains("rotate-45")&&(e(".etc-menu").style.display="none")})};const n=()=>{e("#teacherData").classList.add("-translate-x-full")},o=()=>{e("#teacherData").classList.add("translate-x-full")};e("#navrightbtn").addEventListener("click",n),e("#navleftbtn").addEventListener("click",o);let s=0;e("#navrightbtn").addEventListener("touchstart",t=>{s=t.changedTouches[0].clientX}),e("#navleftbtn").addEventListener("touchstart",t=>{s=t.changedTouches[0].clientX}),e("#navrightbtn").addEventListener("touchend",t=>{const r=t.changedTouches[0].clientX;s-r>50&&n()}),e("#navleftbtn").addEventListener("touchend",t=>{const r=t.changedTouches[0].clientX;s-r<50&&o()}),a("#navbackbtn").forEach(t=>{t.addEventListener("click",()=>{e("#teacherData").classList.remove("-translate-x-full"),e("#teacherData").classList.remove("translate-x-full")})}),a(".teacher-info-btn").forEach(t=>{t.addEventListener("click",()=>{e(".teacher-info-card").classList.remove("translate-x-[600px]"),e(".teacher-info-card").classList.remove("rotate-45"),c()})}),a(".teacher-class-btn").forEach(t=>{t.addEventListener("click",()=>{e(".teacher-class-card").classList.remove("translate-x-[600px]"),e(".teacher-class-card").classList.remove("rotate-45"),c()})}),a(".teacher-contact-btn").forEach(t=>{t.addEventListener("click",()=>{e(".teacher-contact-card").classList.remove("translate-x-[600px]"),e(".teacher-contact-card").classList.remove("rotate-45"),c()})}),a(".teacher-rules-btn").forEach(t=>{t.addEventListener("click",()=>{e(".teacher-rules-card").classList.remove("translate-x-[600px]"),e(".teacher-rules-card").classList.remove("rotate-45"),c()})}),a(".teacher-registration-btn").forEach(t=>{t.addEventListener("click",()=>{e(".teacher-registration-card").classList.remove("translate-x-[600px]"),e(".teacher-registration-card").classList.remove("rotate-45"),c()})}),a(".teacher-qc-btn").forEach(t=>{t.addEventListener("click",()=>{e(".teacher-qc-card").classList.remove("translate-x-[600px]"),e(".teacher-qc-card").classList.remove("rotate-45"),c()})}),a(".card-close-btn").forEach(t=>{t.addEventListener("click",()=>{a(".other-cards").forEach(r=>{!r.classList.contains("translate-x-[600px]")&&!r.classList.contains("rotate-45")&&(r.classList.add("rotate-45"),r.classList.add("translate-x-[600px]"),e(".etc-menu").style.display="flex")})})});let l=0;e("#rotate-btn").addEventListener("click",()=>{l+=180,e("#main-card").style.transform=`rotateY(${l}deg)`,e("#back-card").style.transform=`rotateY(${l+180}deg)`})},u=()=>{let e=n=>document.querySelector(n),a=` <form class="w-full mt-8 p-2" id="qcform">
                  <label
                ...
                </form>`;e("#qc-form-container").insertAdjacentHTML("beforeend",a),e("#qcform").addEventListener("submit",n=>{n.preventDefault(),(async()=>{(await(await fetch("http://localhost:3001/nounces")).json()).find(i=>i.nounce===n.target.children[1].value)?(e("#qcform").remove(),e("#qc-form-container").insertAdjacentHTML("beforeend",c),e(".qc-close").addEventListener("click",()=>{e("#qcRateForm").remove(),e("#qc-form-container").insertAdjacentHTML("beforeend",a)}),e("#qc-cancel").addEventListener("click",()=>{e("#qcRateForm").remove(),e("#qc-form-container").insertAdjacentHTML("beforeend",a)})):alert("کد شما معتبر نیست")})()})};new d(".mySwiper",{autoplay:{delay:1e4,disableOnInteraction:!1},direction:"vertical"});new d(".navSwiper",{slidesPerView:"auto",spaceBetween:10,pagination:{el:".swiper-pagination",clickable:!0}});f();u();document.addEventListener("DOMContentLoaded",()=>{setTimeout(()=>{document.querySelector("#main-card").classList.toggle("-rotate-y-180"),document.querySelector("#back-card").classList.toggle("rotate-y-180"),document.querySelector("#bg-blur").classList.add("backdrop-blur-[3px]")},1e3),setTimeout(()=>{document.querySelector(".etc-menu").classList.remove("opacity-0")},1500)});
